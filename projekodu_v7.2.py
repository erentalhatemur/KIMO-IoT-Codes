...
def mail_gonder(goruntu_tipi):
   ...
   <body>
      <p>Merhaba Eren Talha,<br>
         ...
         çektim! Bu <a href="https://www.dropbox.com/home/Apps/kimo_app2/media">linkten</a> görüntülere ulaşabilirsiniz.
      </p>
   </body>
   </html>
   """
   ...
   mail.ehlo()
   mail.starttls()
   mail.login("kimoguvenlik00@gmail.com","tgwhqcpeftaytlez")   
